...
class FullBorrowDetails extends StatelessWidget {
  static const routeName = "Expense_Details";

  const FullBorrowDetails({Key? key}) : super(key: key);
  @override
      ...
      body: Column(
        children: [
          CustomAppBar(
            ...
            subtitle: "See All Your Borrow Transactions",
            icon: const FaIcon(
          ...
          Expanded(
            child: Padding(
              ...
              child: ValueListenableBuilder(
                valueListenable:
                    TransactionDB.instance.borrowTransactionListner,
