...
class FullLendDetails extends StatelessWidget {
  static const routeName = "Expense_Details";

  const FullLendDetails({Key? key}) : super(key: key);
  @override
      ...
      body: Column(
        children: [
          CustomAppBar(
            ...
            subtitle: "See All Your Lend Transactions",
            icon: const FaIcon(
          ...
          Expanded(
            child: Padding(
              ...
              child: ValueListenableBuilder(
                valueListenable: TransactionDB.instance.lendTransactionListner,
